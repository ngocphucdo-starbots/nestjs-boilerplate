...
This boilerplate comes with [Express](https://expressjs.com/) out of the box as it offers [performance benefits](https://github.com/nestjs/nest/blob/master/benchmarks/all_output.txt) over Express. But this can be changed to use [Fastify](https://github.com/fastify/fastify) framework instead of Express. 
